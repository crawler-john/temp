...
<form class="form-horizontal" id="defaultForm" method="ajax">
  <fieldset>
    ...
    <div class="form-group">
      <label for="inputdata14" class="col-sm-5 control-label"><?php echo $this->lang->line('protection_regulated_dc_working_point')?></label>
      <div class="col-sm-4">
        <div class="input-group">
          <input type="text" name="regulated_dc_working_point" class="form-control" id="inputdata14" placeholder="<?php echo $regulated_dc_working_point;?>">
          <span class="input-group-addon"><div class="unit">V</div></span>
        </div>      
      </div>
    </div>
    ...
    <div class="form-group">
      <label for="inputdata15" class="col-sm-5 control-label"><?php echo $this->lang->line('protection_under_voltage_stage_2')?></label>
      <div class="col-sm-4">
        <div class="input-group">
          <input type="text" name="under_voltage_stage_2" class="form-control" id="inputdata15" placeholder="<?php echo $under_voltage_stage_2;?>">
          <span class="input-group-addon"><div class="unit">V</div></span>
        </div>      
      </div>
    </div>
    ...
    <div class="form-group">
      <label for="inputdata16" class="col-sm-5 control-label"><?php echo $this->lang->line('protection_voltage_3_clearance_time')?></label>
      <div class="col-sm-4">
        <div class="input-group">
          <input type="text" name="voltage_3_clearance_time" class="form-control" id="inputdata16" placeholder="<?php echo $voltage_3_clearance_time;?>">
          <span class="input-group-addon"><div class="unit">s</div></span>
        </div>      
      </div>
    </div>
    ...
    <div class="form-group">
      <label for="inputdata17" class="col-sm-5 control-label"><?php echo $this->lang->line('protection_start_time')?></label>
      <div class="col-sm-4">
        <div class="input-group">
          <input type="text" name="start_time" class="form-control" id="inputdata17" placeholder="<?php echo $start_time;?>">
          <span class="input-group-addon"><div class="unit">s</div></span>
        </div>      
      </div>
    </div>
    ...
    <table class="table table-condensed table-striped table-hover table-bordered">
        ...
        <tr>
          <?php
            if(!empty($parameters))
            {
              ...
              echo "<th>".$this->lang->line('protection_regulated_dc_working_point')."</th>";
              echo "<th>".$this->lang->line('protection_under_voltage_stage_2')."</th>";
              echo "<th>".$this->lang->line('protection_voltage_3_clearance_time')."</th>";
              echo "<th>".$this->lang->line('protection_start_time')."</th>";
            }
          ?>         
        </tr>
      </thead>
      ...
      <?php
          foreach ($parameters as $value) 
          {
              ...
              echo "<td>".$value['regulated_dc_working_point']."</td>";
              echo "<td>".$value['under_voltage_stage_2']."</td>";
              echo "<td>".$value['voltage_3_clearance_time']."</td>";
...
$(document).ready(function() 
{
        ...
        fields: {
            ...
            regulated_dc_working_point: {
                validators: {
                    ...
                    regexp: {
                        regexp: /^0*\d{1,2}(\.\d)?$/,
                        message: '<?php echo $this->lang->line('validform_regulated_dc_working_point')?>'
                    }
                }
            },
            under_voltage_stage_2: {
                validators: {
                    ...
                    regexp: {
                        regexp: /^\d{0,3}$/,
                        message: '<?php echo $this->lang->line('validform_under_voltage_stage_2')?>'
                    }
                }
            },
            voltage_3_clearance_time: {
                validators: {
                    ...
                    regexp: {
                        regexp: /^0*\d{1,3}(\.\d{1,2})?$/,
                        message: '<?php echo $this->lang->line('validform_voltage_3_clearance_time')?>'
                    }
                }
            },
            start_time: {
                validators: {
                    ...
                    regexp: {
                        regexp: /^\d{0,5}$/,
                        message: '<?php echo $this->lang->line('validform_start_time')?>'
                    }
                }
            }
        }
    ...
    $("#button_save").click(function(){
    	$("#result").hide();    	
	    $.ajax({
    		url : "<?php echo base_url('index.php/configuration/set_protection17');?>",
    		type : "post",
            dataType : "json",
    		data: "inverter=" + $("#inputdata0").val()
    		      ...
    		      + "&regulated_dc_working_point=" + $("#inputdata14").val() 
    		      + "&under_voltage_stage_2=" + $("#inputdata15").val() 
    		      + "&voltage_3_clearance_time=" + $("#inputdata16").val()
    		      + "&start_time=" + $("#inputdata17").val(),
